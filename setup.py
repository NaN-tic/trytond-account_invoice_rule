...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-account_invoice_rule',
    download_url='https://github.com:nantic/trytond-account_invoice_rule.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-account_invoice_rule.git'
    },
    classifiers=[
